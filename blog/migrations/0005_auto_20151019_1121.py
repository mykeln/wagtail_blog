...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='parent',
            field=models.ForeignKey(on_delete=models.CASCADE, to='blog.BlogCategory', help_text='Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional.', related_name='children', null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='blogpage',
            name='date',
